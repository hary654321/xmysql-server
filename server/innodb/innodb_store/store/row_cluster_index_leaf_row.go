...
func NewClusterLeafRowHeader(frmMeta tuple.TableRowTuple) basic.FieldDataHeader {
...
func NewClusterLeafRowHeaderWithContents(frmMeta tuple.TableRowTuple, content []byte) basic.FieldDataHeader {
	var clr = new(ClusterLeafRowHeader)
	clr.FrmMeta = frmMeta
	clr.VarLengthContentMap = make(map[byte]uint16)
	//计算列长度
...
func NewClusterLeafRowData(meta *TableTupleMeta) basic.FieldDataValue {
...
func NewClusterLeafRowDataWithContents(content []byte, meta tuple.TableRowTuple) basic.FieldDataValue {
	var clusterLeafRowData = new(ClusterLeafRowData)
...
func NewClusterLeafRow(content []byte, tableTuple tuple.TableRowTuple) basic.Row {
...
func NewClusterLeafRowWithFrm(meta *TableTupleMeta) basic.Row {
	var rows = &ClusterLeafRow{
		header:  NewClusterLeafRowHeader(meta.GetPrimaryClusterLeafTuple()),
...
func NewClusterLeafRowWithContent(content []byte, tableTuple tuple.TableRowTuple) basic.Row {
