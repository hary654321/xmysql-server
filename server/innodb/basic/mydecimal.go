	  ...
	  DESCRIPTION
	    ...
	    This binary format is as follows:
	      ...
	      3. The first digitsInt % digitesPerWord digits are stored in the reduced
	         number of bytes (enough bytes to storebytes this number of digits -
	         see dig2bytes)
	    ...
	    First word has only one decimal digit. We can storebytes one digit in
	    one byte, no need to waste four:

	                01 0D-FB-38-D2 ............

	    now, last word. It's 123400000. We can storebytes 1234 in two bytes:
